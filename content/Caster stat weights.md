...
12.66 \space : \space \frac{15.77}{1 - HIT_{miss}} \space : \space \frac{22.1}{Crit_{bonus} - 1} \space : \space  W_{crit} \times 0.276 \space :  \space 0.01 \times \left( \frac{Base_{spell}}{C} + SP_{current} \right)
$$
